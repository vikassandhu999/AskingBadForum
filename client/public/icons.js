...
!(function () {
    ...
    var e,
        ...
        n = function (e, t) {
            ...
            n && (a.setAttributeNode(document.createAttribute("data-auto-fetch-svg")), a.setAttribute("data-fetch-svg-from", t.fetchSvgFrom)),
    ...
    try {
        if (window.FontAwesomeKitConfig) {
            ...
            "pro" === e.license && ((t.autoFetchSvg = !0), (t.fetchSvgFrom = e.baseUrl + "/releases/" + ("latest" === e.version ? "latest" : "v".concat(e.version)) + "/svgs")),
            e.v4shim.enabled &&
            n(
                h(e, {
                    shim: !0,
